...
public interface UserService {
    ...
    OAuthLoginResponse findLoginResponse(OAuthUserInfo oauthUserInfo);

    OAuthLoginResponse loginOrRegister(OAuthUserInfo oauthUserInfo, IdentityInfo identityInfo);
